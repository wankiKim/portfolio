...
const journeyKo: JourneyPhase[] = [
  ...
  { phase: 4, title: "AI 네이티브로 확장하다", period: "2025 ~ 현재", icon: "Sparkles", description: "연구소장으로서 무인카페 플랫폼을 펌웨어부터 클라우드까지 수직 통합하고, 레거시 시스템의 MSA 전환을 이끌며, Claude Code 중심의 AI 네이티브 개발로 팀 규모의 결과물을 만들어냅니다.", highlights: ["무인카페 플랫폼 수직 통합 (펌웨어→클라우드)", "레거시 → MSA 전환 3회 완주", "오픈소스 기반 로우코드 플랫폼 고도화", "Claude Code 기반 AI 네이티브 개발"] },
];
...
const journeyEn: JourneyPhase[] = [
  ...
  { phase: 4, title: "Expanding AI-Native", period: "2025 ~ Present", icon: "Sparkles", description: "As R&D Lab Director: vertically integrating an unmanned-café platform from firmware to cloud, leading legacy-to-MSA conversions, and delivering team-scale output through Claude Code–centered AI-native development.", highlights: ["Unmanned-café platform, firmware to cloud", "Three legacy → MSA conversions shipped", "Extending an open-source low-code platform", "AI-native development with Claude Code"] },
];
