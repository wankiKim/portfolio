    ...
    cases: [
      {
        ...
        description: "5년간의 거래소 개발 경험 위에, 레거시 Java/Spring 거래소를 Claude Code와 함께 Go 13개 서비스 + Rust 매칭 엔진 2개로 재플랫폼. 가격-시간 우선순위 오더북과 선물 파생상품 엔진을 구현하고, Terraform으로 AWS ECS 인프라 자동화까지 1인 완성해 라이브 데모로 운영 중.",
      },
    ...
    cases: [
      {
        ...
        description: "Building on 5 years of exchange experience, re-platformed a legacy Java/Spring exchange into 13 Go services + 2 Rust matching engines with Claude Code. Price-time priority orderbook, a full futures derivatives engine, and Terraform-automated AWS ECS infrastructure — solo, running as a live demo.",
      },
