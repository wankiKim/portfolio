    ...
    cases: [
      {
        ...
        blogUrl: "https://wankikim.github.io/project/exchange-replatform-go-rust/",
        techStack: ["Go", "Rust", "Kafka", "Next.js", "Terraform", "AWS"],
        metrics: ["13 Go services + 2 Rust matching engines, 48,000+ LOC", "12 market-making bots, 100+ orders/sec", "Futures liquidation, funding-rate & TP/SL engines", "Trading, admin & agent web plus the backend live in 21 containers on one EC2"],
        description: "Building on 5 years of exchange experience, re-platformed a legacy Java/Spring exchange into 13 Go services + 2 Rust matching engines with Claude Code. Price-time priority orderbook, a full futures derivatives engine, and Terraform-automated infrastructure — solo, and still running live.",
      },
