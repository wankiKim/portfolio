...
const capKo: Capability[] = [
  { title: "시스템 아키텍처", icon: "LayoutDashboard", description: "MSA·이벤트 드리븐 설계 — Outbox·Saga·CloudEvents·멱등성 처리를 라이브러리 수준으로 표준화하고, ArchUnit으로 아키텍처 규칙을 CI에서 강제합니다." },
  { title: "레거시 현대화", icon: "RefreshCw", description: "PHP·Django·Java 모놀리스를 MSA로 전환해 실운영까지 완주 3회. 스트랭글러 패턴, 패리티 검증, 컷오버 런북, NCP→AWS 무중단 마이그레이션까지." },
